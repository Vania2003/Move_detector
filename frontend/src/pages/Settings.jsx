...
import { FiSettings, FiCheck, FiRefreshCw, FiMail, FiLink, FiXCircle } from "react-icons/fi";
    ...
    <div className="space-y-8 max-w-2xl">
      ...
      <div className="flex gap-3 pt-1">
        <button type="button" onClick={save} disabled={saving}
          className="border border-green-600 text-green-700 dark:text-green-300 hover:bg-green-50 dark:hover:bg-green-900/20 rounded-md px-5 py-2 flex items-center gap-2 no-bright-hover">
          {saving ? <Spinner size={18}/> : <FiCheck/>} Save
        </button>
        <button type="button" onClick={load} className="border-2 border-blue-500 dark:border-blue-400 text-blue-700 dark:text-blue-200 font-semibold hover:bg-blue-500/10 dark:hover:bg-blue-400/10 focus:ring-2 focus:ring-blue-500 focus:outline-none rounded-md px-5 py-2 flex items-center gap-2 transition-all">
          <FiRefreshCw />
